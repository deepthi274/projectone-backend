...
public class Controller {
	...
	// ADD AN IMAGE
	// http://localhost:8080/api/images/add (200 OK)
	@PostMapping("images/add")
	ImagePojo addImage(@Valid @RequestBody ImagePojo imagePojo) throws ApplicationException {
		return imageService.addImage(imagePojo);
	}

	// GET AN IMAGE
	// http://localhost:8080/api/images/1 (200 OK)
	...
	public String saveProduct(@RequestParam("file") MultipartFile file, @RequestParam("user_id") int userId) {
		imageService.saveImageToDB(file, userId);
		return " ";
	}

	// UPDATE AN IMAGE
	// http://localhost:8080/api/images/update/1 (200 OK)
	@PutMapping("images/update/{imgid}")
	ImagePojo updateImage(@Valid @RequestBody ImagePojo imagePojo) throws ApplicationException {
		return imageService.updateImage(imagePojo);
	}

	// DELETE AN IMAGE
	// http://localhost:8080/api/images/delete/1 (200 OK)
